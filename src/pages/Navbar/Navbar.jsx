...
const Navbar = () => {
    ...
    const link = <>
        ...
        {
            user && isAdmins && <NavLink to={'/dasbord/adminHome'} className='lg:text-white font-bold sm:text-black'>DASHBOARD</NavLink>
        }
        {
            user && !isAdmins && <NavLink to={'/dasbord/userHome'} className='lg:text-white font-bold sm:text-black'>DASHBOARD</NavLink>
        }
            ...
            <div className="navbar container mx-auto min-h-28">
                ...
                <div className="flex-none">
                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu menu-sm lg:hidden dropdown-content border-2 bg-gray-500 max-sm:text-white rounded-none z-[1] space-y-3 mt-3 w-52 p-2 shadow">
                            {link}
                            {
